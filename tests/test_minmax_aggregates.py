...
__chain_min___min_0_0_11(P,V) :- skill(P,ID,V); person(P).
__chain_min___min_0_0_11(P,__NEXT) :- __chain_min___min_0_0_11(P,__PREV); __next_0__dom___min_0_0_11(__PREV,__NEXT).
__min_0_0_11(P,__NEXT) :- __chain_min___min_0_0_11(P,__NEXT); not __chain_min___min_0_0_11(P,__PREV): __next_0__dom___min_0_0_11(__PREV,__NEXT).
__min_0_0_11(P,#sup) :- __max_0__dom___min_0_0_11(X); not __chain_min___min_0_0_11(P,X); person(P).
